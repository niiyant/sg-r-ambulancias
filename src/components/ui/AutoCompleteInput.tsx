          ...
          >
            {filteredOptions.map((option) => (
              <button
                key={option.value}
                type="button"
                className="w-full px-3 py-2 text-left text-base text-gray-900 hover:bg-gray-100 focus:bg-gray-100 focus:outline-none sm:text-sm"
            ...
            {showNewOption && (
              <button
                type="button"
                className="w-full px-3 py-2 text-left text-base text-blue-600 hover:bg-blue-50 focus:bg-blue-50 focus:outline-none border-t border-gray-200 font-medium sm:text-sm"
